...
const LoginPage = () => {
  ...
  // Get the intended destination from navigation state or default to profile
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('amourFloralsUser', JSON.stringify({
      name: 'Olivia Chen', // This would come from backend
      email: formData.email,
      isLoggedIn: true
    }));

    alert('Logged in successfully!');
    navigate(from); // Redirect to intended page or profile
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 to-pink-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          {/* Welcome Header */}
          <div className="text-center mb-8">
            <h1 className="text-2xl font-light text-gray-800 mb-2">Welcome Back, Bloom Lover</h1>
            <p className="text-gray-600">Sign in to your garden.</p>
          </div>
